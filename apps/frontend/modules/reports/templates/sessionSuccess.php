	...
	<div id="index_page">
		...
		<div class="page_content">
			...
			<?php if($sf_user->isAuthenticated()): ?>
					...
					<a id="edit-button" class="small_btn" href="<?php echo url_for("print_report", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"], "id" => $currentSession["id"])); ?>" title="Print report">Print</a>
			<?php endif; ?>
				...
				<div class="container">
					<div id="test_results_navi">
						<?php if(isset($previousSession)): ?>
							<a class="go_to_previous" href="<?php echo url_for("test_session", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"], "id" => $previousSession["id"], "display" => $currentDisplay)); ?>" title="Previous report">Previous report</a>
						<?php endif; ?>

						<?php if(isset($nextSession)): ?>
							<a class="go_to_next" href="<?php echo url_for("test_session", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"], "id" => $nextSession["id"], "display" => $currentDisplay)); ?>" title="Next report">Next report</a>
						<?php endif; ?>
					...
					<span style="float: right">
						Switch to:
						<a class="shortcut_link_big<?php if($currentDisplay == "basic") echo "_active"; ?>" href="<?php echo url_for("test_session", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"], "id" => $currentSession["id"], "display" => "basic")); ?>#test_features" title="Basic">Basic</a>
						<a class="shortcut_link_big<?php if($currentDisplay == "detailed") echo "_active"; ?>" href="<?php echo url_for("test_session", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"], "id" => $currentSession["id"], "display" => "detailed")); ?>#test_features" title="Detailed">Detailed</a>
						<a class="shortcut_link_big<?php if($currentDisplay == "history") echo "_active"; ?>" href="<?php echo url_for("test_session", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"], "id" => $currentSession["id"], "display" => "history")); ?>#test_features" title="History">History</a>
					</span>
						...
						<tbody> <?php
							...
							foreach($currentSession["features"] as $feature)
							{
								...
								<tr class="feature_record <?php echo ($line % 2 == 0) ? "odd" : "even"; ?>"> <?php
									...
									$urlFeature = ($currentDisplay != "detailed") ? url_for("test_session", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"], "id" => $currentSession["id"], "display" => "detailed")) : "";
								?>
						...
						<tbody> <?php
							...
							foreach($currentSession["features"] as $feature)
							{
								...
								<tr class="feature_record <?php echo ($line % 2 == 0) ? "odd" : "even"; ?>"> <?php
									...
									$urlFeature = ($currentDisplay != "history") ? url_for("test_session", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"], "id" => $currentSession["id"], "display" => "history")) : "";
								?>
						...
						<table class="detailed_results history">
							<thead>
								...
								<tr>
									...
									<?php for($i=count($previousSessions)-1; $i>=0; $i--): ?>
										<th class="th_history_result"><a href="<?php echo url_for("test_session", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"], "id" => $previousSessions[$i]["id"])); ?>" title="<?php echo "(".$previousSessions[$i]["id"].") ".$previousSessions[$i]["name"]; ?>"><?php echo format_datetime($previousSessions[$i]["created_at"], "y-MM-dd HH:mm"); if(!empty($previousSessions[$i]["build_id"])) echo " Build ID: ".$previousSessions[$i]["build_id"]; ?></a></th>
									<?php endfor; ?>
