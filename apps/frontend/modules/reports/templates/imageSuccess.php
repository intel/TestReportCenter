			...
			<thead>
				<tr>
					<th class="filtered" scope="col">
						<?php echo $currentProduct["name"]." / ".$currentEnvironment["name"]." / ".$currentImage["name"]; ?>
						<a class="rss" href="<?php echo url_for("rss_image", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"])); ?>" title="RSS feed"></a>
					</th>
				</tr>
			</thead>
				...
				<tr>
					<td class="filtered">
						<div class="chart_actions stack_chart">
							...
							<a id="csv_report_link" href="<?php echo url_for("export_image", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"])); ?>" title="Download as CSV">Download as CSV</a>
						</div>

						<div class="index_section">
						<?php if(!empty($lastSessions[0]) AND !empty($lastSessions[1])): ?>
							<a class="compare" href="<?php echo url_for("compare_reports", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"])); ?>" >See detailed comparison</a>
						<?php endif; ?>
							<div class="clearfix">
								<h2></h2>
									...
									foreach($sessionsForImages as $data)
									{
										...
										<tr class="<?php echo ($rowCount%2 == 0) ? "even" : "odd"; ?>">
											...
											<td class="report_name">
												<a href="<?php echo url_for("test_session", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"], "id" => $data["id"], "display" => "basic")); ?>" title="See basic report" class="shortcut_link">Basic</a>
												<a href="<?php echo url_for("test_session", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"], "id" => $data["id"], "display" => "detailed")); ?>" title="See detailed report" class="shortcut_link">Detailed</a>
												<a href="<?php echo url_for("test_session", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $currentImage["name_slug"], "id" => $data["id"], "display" => "history")); ?>" title="See history report" class="shortcut_link">History</a>
