...
<div id="page">
	<div id="index_page">
		<div id="breadcrumb">
			<li><a href="<?php echo url_for("project_testsets", array("project" => $currentProject["name_slug"], "filter" => "recent")); ?>" title="Home">Home</a></li>
			...
			<thead>
				<tr>
					<th class="filtered" scope="col">
						...
						<a class="rss" href="<?php echo url_for("rss_testset_product", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"])); ?>" title="RSS feed"></a>
					</th>
				</tr>
			</thead>
				...
				<tr>
					<td class="filtered">
						<div class="chart_actions stack_chart">
							...
							<a id="csv_report_link" href="<?php echo url_for("export_product_testset", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"])); ?>" title="Download as CSV">Download as CSV</a>
						</div>
						...
						<div class="index_month" id="reports_by_month"> <?php
							...
							<?php foreach($sessionsForImages as $data): ?>
								<?php if($previousBuild != $data["testset"]): ?>
									<?php $rowCount = 0; ?>
									<table class="month">
										<thead>
											<tr>
												<td class="index_month_title" colspan="3">
													<strong class="name"><?php echo $data["testset"]; ?></strong>
												</td>
											</tr>
										</thead>
								...
								<?php endif; ?>
											...
											<tr class="<?php echo ($rowCount%2 == 0) ? "even" : "odd"; ?>">
												...
												<td class="report_name">
													<a href="<?php echo url_for("testset_session", array("testset" => $data["testset_slug"], "project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $data["te_slug"], "image" => $data["i_slug"], "id" => $data["id"], "display" => "basic")); ?>" title="See basic report" class="shortcut_link">Basic</a>
													<a href="<?php echo url_for("testset_session", array("testset" => $data["testset_slug"], "project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $data["te_slug"], "image" => $data["i_slug"], "id" => $data["id"], "display" => "detailed")); ?>" title="See detailed report" class="shortcut_link">Detailed</a>
													<a href="<?php echo url_for("testset_session", array("testset" => $data["testset_slug"], "project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $data["te_slug"], "image" => $data["i_slug"], "id" => $data["id"], "display" => "history")); ?>" title="See history report" class="shortcut_link">History</a>
											...
											if($rowCount == $limit && $sessionsForImages[$globalRowCount]["testset"] == $previousBuild)
											{ ?>
												<tr>
								...
								<?php $previousBuild = $data["testset"]; ?>
							<?php endforeach; ?>
