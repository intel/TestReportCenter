			...
			<thead>
				<tr>
					<th class="filtered" scope="col">
						<?php echo $currentProduct["name"]." / ".$currentTestset["testset"]." / ".$currentEnvironment["name"]; ?>
						<a class="rss" href="<?php echo url_for("rss_testset_environment", array("testset" => $currentTestset["testset_slug"], "project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"])); ?>" title="RSS feed"></a>
					</th>
				</tr>
			</thead>
				...
				<tr>
					<td class="filtered">
						<div class="chart_actions stack_chart">
							...
							<a id="csv_report_link" href="<?php echo url_for("export_environment_testset", array("testset" => $currentTestset["testset_slug"], "project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"])); ?>" title="Download as CSV">Download as CSV</a>
						</div>
								...
								<?php endif; ?>
											...
											<tr class="<?php echo ($rowCount%2 == 0) ? "even" : "odd"; ?>">
												...
												<td class="report_name">
													<a href="<?php echo url_for("testset_session", array("testset" => $currentTestset["testset_slug"], "project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $data["i_slug"], "id" => $data["id"], "display" => "basic")); ?>" title="See basic report" class="shortcut_link">Basic</a>
													<a href="<?php echo url_for("testset_session", array("testset" => $currentTestset["testset_slug"], "project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $data["i_slug"], "id" => $data["id"], "display" => "detailed")); ?>" title="See detailed report" class="shortcut_link">Detailed</a>
													<a href="<?php echo url_for("testset_session", array("testset" => $currentTestset["testset_slug"], "project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $currentEnvironment["name_slug"], "image" => $data["i_slug"], "id" => $data["id"], "display" => "history")); ?>" title="See history report" class="shortcut_link">History</a>
