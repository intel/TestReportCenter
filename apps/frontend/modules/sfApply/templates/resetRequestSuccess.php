...
<div class="sf_apply sf_apply_reset">
	<form method="POST" action="<?php echo url_for("sfApply/resetRequest") ?>" name="sf_apply_reset_form" id="sf_apply_reset_form">
		...
		<ul>
			...
			<div id="wizard_actions">
				<div id="wizard_buttons">
					...
					<input class="big_btn next" type="submit" value="Next" name="commit">
				</div>
			</div>
		</ul>
	</form>
