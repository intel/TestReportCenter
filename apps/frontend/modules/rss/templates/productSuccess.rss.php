...
Pass rate of executed: <?php echo round($data["pass"] / ($data["pass"] + $data["fail"]) * 100); ?>
				...
				<link><?php echo url_for("test_session", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $data["te_slug"], "image" => $data["i_slug"], "id" => $data["id"]), true); ?></link>
				<guid><?php echo url_for("test_session", array("project" => $currentProject["name_slug"], "product" => $currentProduct["name_slug"], "environment" => $data["te_slug"], "image" => $data["i_slug"], "id" => $data["id"]), true); ?></guid>
			</item>
		<?php endforeach; ?>
	</channel>
</rss>
