...
/**
 * DbHistory filter form base class.
 *
 * @package    trc
 * @subpackage filter
 ...
 */
abstract class BaseDbHistoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('db_history_filters[%s]');
